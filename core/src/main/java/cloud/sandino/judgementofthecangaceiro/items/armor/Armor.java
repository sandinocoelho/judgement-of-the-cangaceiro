...
package cloud.sandino.judgementofthecangaceiro.items.armor;
...
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.AntiEntropy;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Bulk;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Corrosion;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Displacement;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Metabolism;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Multiplicity;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Overgrowth;
import cloud.sandino.judgementofthecangaceiro.items.armor.curses.Stench;
import cloud.sandino.judgementofthecangaceiro.items.armor.glyphs.Affection;
...
import cloud.sandino.judgementofthecangaceiro.items.armor.glyphs.Camouflage;
import cloud.sandino.judgementofthecangaceiro.items.armor.glyphs.Entanglement;
...
import cloud.sandino.judgementofthecangaceiro.items.armor.glyphs.Repulsion;
...
import cloud.sandino.judgementofthecangaceiro.items.armor.glyphs.Thorns;
