...
import cloud.sandino.judgementofthecangaceiro.items.EnergyCrystal;
...
import cloud.sandino.judgementofthecangaceiro.items.KingsCrown;
import cloud.sandino.judgementofthecangaceiro.items.LiquidMetal;
import cloud.sandino.judgementofthecangaceiro.items.Stylus;
import cloud.sandino.judgementofthecangaceiro.items.TengusMask;
import cloud.sandino.judgementofthecangaceiro.items.Torch;
...
import cloud.sandino.judgementofthecangaceiro.items.bags.PotionBandolier;
import cloud.sandino.judgementofthecangaceiro.items.bags.ScrollHolder;
...
import cloud.sandino.judgementofthecangaceiro.items.bombs.Firebomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.FlashBangBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.FrostBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.HolyBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.Noisemaker;
import cloud.sandino.judgementofthecangaceiro.items.bombs.RegrowthBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.ShrapnelBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.SmokeBomb;
import cloud.sandino.judgementofthecangaceiro.items.bombs.WoollyBomb;
import cloud.sandino.judgementofthecangaceiro.items.food.Berry;
import cloud.sandino.judgementofthecangaceiro.items.food.Blandfruit;
import cloud.sandino.judgementofthecangaceiro.items.food.ChargrilledMeat;
import cloud.sandino.judgementofthecangaceiro.items.food.Food;
import cloud.sandino.judgementofthecangaceiro.items.food.FrozenCarpaccio;
...
import cloud.sandino.judgementofthecangaceiro.items.food.PhantomMeat;
import cloud.sandino.judgementofthecangaceiro.items.food.SmallRation;
import cloud.sandino.judgementofthecangaceiro.items.food.StewedMeat;
import cloud.sandino.judgementofthecangaceiro.items.food.SupplyRation;
...
import cloud.sandino.judgementofthecangaceiro.items.quest.CeremonialCandle;
...
import cloud.sandino.judgementofthecangaceiro.items.quest.Embers;
...
import cloud.sandino.judgementofthecangaceiro.items.remains.BowFragment;
import cloud.sandino.judgementofthecangaceiro.items.remains.BrokenHilt;
import cloud.sandino.judgementofthecangaceiro.items.remains.BrokenStaff;
import cloud.sandino.judgementofthecangaceiro.items.remains.CloakScrap;
import cloud.sandino.judgementofthecangaceiro.items.remains.SealShard;
import cloud.sandino.judgementofthecangaceiro.items.remains.TornPage;
